...
from uv_app.plugins.toggl.df_to_mysql import (
...
class TogglPlugin(PluginInterface):
    ...
    def write_to_database(self, df: pd.DataFrame) -> Tuple[int, int]:
        ...
        if df is not None and not df.empty:
            ...
            inserted_count, duplicate_count = write_toggl_dataframe_to_mysql_batch(df)
    ...
    def setup_database(self) -> bool:
        ...
        execute_sql_file("uv_app/plugins/toggl/sql/toggl_entries.sql")
        return True
