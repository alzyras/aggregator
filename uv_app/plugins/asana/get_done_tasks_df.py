...
def get_completed_tasks(access_token, project_gid):
...
def process_tasks_to_dataframe(access_token, workspace_gid):
    ...
    for project in projects:
        ...
        tasks = get_completed_tasks(access_token, project_gid)
        for task in tasks:
            completed_at = (
...
def get_asana_completed_tasks_df(personal_access_token, workspace_gid):
    """
    ...
    try:
        df = process_tasks_to_dataframe(personal_access_token, workspace_gid)
        return df
