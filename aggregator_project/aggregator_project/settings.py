...
SYNC_INCREMENTAL_LOOKBACK_MINUTES = max(
    int(_env("SYNC_INCREMENTAL_LOOKBACK_MINUTES", "5") or "5"),
    0,
)
AUTO_REFRESH_SCHEDULER_TICK_SECONDS = max(
    int(_env("AUTO_REFRESH_SCHEDULER_TICK_SECONDS", "60") or "60"),
    5,
)
